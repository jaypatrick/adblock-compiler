            ...
            sidebar: [
                ...
                { label: 'API Reference', link: '/api-reference' },
                {
                    ...
                    items: [
                        ...
                        { label: 'Registry UI Integration', link: '/api/REGISTRY_UI_INTEGRATION' },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'Sentry Best Practices', link: '/observability/SENTRY_BEST_PRACTICES' },
                        { label: 'Sentry Durable Objects & Workflows', link: '/observability/SENTRY_DURABLE_OBJECTS' },
                        { label: 'Cloudflare Native Observability', link: '/observability/CLOUDFLARE_OBSERVABILITY' },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'Services Overview', link: '/cloudflare/CLOUDFLARE_SERVICES' },
                        ...
                        { label: 'Browser Rendering', link: '/cloudflare/BROWSER_RENDERING' },
                        { label: 'D1 Database', link: '/cloudflare/CLOUDFLARE_D1' },
                        { label: 'Workflows', link: '/cloudflare/CLOUDFLARE_WORKFLOWS' },
                        { label: 'Queue Diagnostics', link: '/cloudflare/QUEUE_DIAGNOSTICS' },
                        ...
                        { label: 'Email Delivery Workflow', link: '/cloudflare/EMAIL_DELIVERY_WORKFLOW' },
                    ],
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'Multi-Tenancy Schema', link: '/database-setup/multi-tenancy-schema' },
                        { label: 'Architecture', link: '/database-setup/DATABASE_ARCHITECTURE' },
                        { label: 'Neon Migration Summary', link: '/database-setup/neon-migration-summary' },
                        { label: 'Neon Setup', link: '/database-setup/neon-setup' },
                        { label: 'Neon Branching', link: '/database-setup/neon-branching' },
                        { label: 'Edge Cache Architecture', link: '/database-setup/edge-cache-architecture' },
                        { label: 'Migration Checklist', link: '/database-setup/migration-checklist' },
                        { label: 'Local Development', link: '/database-setup/local-dev' },
                        { label: 'Modern Postgres', link: '/database-setup/postgres-modern' },
                        { label: 'Prisma Schema Reference', link: '/database-setup/prisma-schema-reference' },
                        { label: 'Prisma Deno Compatibility', link: '/database-setup/prisma-deno-compatibility' },
                        { label: 'Evaluation', link: '/database-setup/DATABASE_EVALUATION' },
                        { label: 'Prisma Evaluation', link: '/database-setup/PRISMA_EVALUATION' },
                    ],
                },
                {
                    label: 'Deployment',
                    items: [
                        ...
                        { label: 'Cloudflare Containers', link: '/deployment/cloudflare-containers' },
                        { label: 'Cloudflare Pages', link: '/deployment/cloudflare-pages' },
                        { label: 'Cloudflare Workers Architecture', link: '/deployment/CLOUDFLARE_WORKERS_ARCHITECTURE' },
                        { label: 'Deployment Environments', link: '/deployment/ENVIRONMENTS' },
                        { label: 'Deployment Versioning', link: '/deployment/DEPLOYMENT_VERSIONING' },
                        { label: 'Gradual Deployments', link: '/deployment/GRADUAL_DEPLOYMENTS' },
                        { label: 'Disaster Recovery', link: '/deployment/DISASTER_RECOVERY' },
                        { label: 'Docker', link: '/deployment/DOCKER' },
                        { label: 'Production Readiness', link: '/deployment/PRODUCTION_READINESS' },
                        { label: 'Production Secrets', link: '/deployment/PRODUCTION_SECRETS' },
                    ],
                },
                {
                    label: 'Development',
                    items: [
                        ...
                        { label: 'Developer Onboarding', link: '/development/DEVELOPER_ONBOARDING' },
                        { label: 'Diagnostics', link: '/development/DIAGNOSTICS' },
                        { label: 'Full Diagnostics Tool (diag-full)', link: '/development/DIAG_FULL' },
                ...
                },
                {
                    label: 'Architecture',
                    items: [
                        { label: 'System Architecture', link: '/architecture/SYSTEM_ARCHITECTURE' },
                        { label: 'Multi-Tenancy Architecture', link: '/architecture/MULTI_TENANCY' },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'Angular Parity Checklist', link: '/frontend/ANGULAR_PARITY_CHECKLIST' },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'User Migration Guide', link: '/guides/USER_MIGRATION_GUIDE' },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'Schema Reference', link: '/configuration/schema-reference' },
                        { label: 'Environment Overrides', link: '/configuration/env-overrides' },
                        { label: 'Load Flow Diagram', link: '/configuration/flow-diagram' },
                        { label: 'Terraform / IaC Extensibility', link: '/configuration/terraform-extensibility' },
                    ],
                },
                { label: 'Postman', link: '/postman/' },
                {
                    ...
                    items: [
                        ...
                        { label: 'Auto Version Bump', link: '/reference/AUTO_VERSION_BUMP' },
                        { label: 'Bugs & Features', link: '/reference/BUGS_AND_FEATURES' },
                        { label: 'Environment Configuration', link: '/reference/ENV_CONFIGURATION' },
                        { label: 'GitHub Issue Templates', link: '/reference/GITHUB_ISSUE_TEMPLATES' },
                        { label: 'Lighthouse CI', link: '/reference/LIGHTHOUSE_CI' },
                        { label: 'AI Assistant Guide', link: '/reference/claude' },
                        { label: 'Version Management', link: '/reference/VERSION_MANAGEMENT' },
                    ],
                },
                {
                    label: 'Releases',
                    items: [
                        ...
                        { label: 'Blog Post', link: '/releases/BLOG_POST_ADBLOCK_COMPILER' },
                    ],
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'Multi-Tenancy & Organizations', link: '/auth/multi-tenancy' },
                        { label: 'Auth Provider Selection', link: '/auth/auth-provider-selection' },
                        { label: 'Auth Chain Reference', link: '/auth/auth-chain-reference' },
                        { label: 'Better Auth + Prisma', link: '/auth/better-auth-prisma' },
                        { label: 'Migration: Clerk → Better Auth', link: '/auth/migration-clerk-to-better-auth' },
                        ...
                        { label: 'Removing Anonymous Access', link: '/auth/removing-anonymous-access' },
                        { label: 'CLI Authentication', link: '/auth/cli-authentication' },
                        { label: 'Clerk Dashboard Setup', link: '/auth/clerk-setup' },
                        { label: 'Clerk + Cloudflare Integration', link: '/auth/clerk-cloudflare-integration' },
                ...
                },
                {
                    label: 'Security',
                    items: [
                        { label: 'Zero Trust Architecture', link: '/security/ZERO_TRUST_ARCHITECTURE' },
                        { label: 'ZTA Developer Guide', link: '/security/ZTA_DEVELOPER_GUIDE' },
                        { label: 'API Shield Vulnerability Scanner', link: '/security/API_SHIELD_VULNERABILITY_SCANNER' },
                        { label: 'Page Shield Integration', link: '/security/PAGE_SHIELD_INTEGRATION' },
                        { label: 'Automated Web Asset Sync', link: '/security/API_SHIELD_WEB_ASSETS' },
                    ],
                },
                {
                    label: 'Testing',
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'KB-001: API Not Available', link: '/troubleshooting/KB-001-api-not-available' },
                        { label: 'KB-002: Hyperdrive Database Down', link: '/troubleshooting/KB-002-hyperdrive-database-down' },
                        { label: 'KB-003: Database Down After Deploy — Live Session', link: '/troubleshooting/KB-003-neon-hyperdrive-live-session-2026-03-25' },
                        { label: 'KB-004: Prisma WASM Error on Cloudflare Workers', link: '/troubleshooting/KB-004-prisma-wasm-cloudflare' },
                        { label: 'Neon Troubleshooting', link: '/troubleshooting/neon-troubleshooting' },
                    ],
                },
                {
                    label: 'Ops Tools',
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'Workflow Linting (actionlint)', link: '/workflows/ACTIONLINT' },
                        { label: 'Environment Setup', link: '/workflows/ENV_SETUP' },
                        { label: 'Workflow Diagrams', link: '/workflows/WORKFLOW_DIAGRAMS' },
                        { label: 'Workflow Improvements', link: '/workflows/WORKFLOW_IMPROVEMENTS' },
                        { label: 'Workflow Cleanup Summary', link: '/workflows/WORKFLOW_CLEANUP_SUMMARY' },
                    ],
                },
                {
