...
| **REST API Endpoint** | `ep-winter-term-a8rxh2a9.apirest.eastus2.azure.neon.tech/neondb/rest/v1` |
...
```
postgresql://<user>:<password>@ep-winter-term-a8rxh2a9-pooler.eastus2.azure.neon.tech/<database>?sslmode=require
```
