...
- [Observability](observability/README.md)
  ...
  - [Sentry Durable Objects & Workflows](observability/SENTRY_DURABLE_OBJECTS.md)
...
- [Cloudflare Integration](cloudflare/README.md)
  ...
  - [Email Service](cloudflare/EMAIL_SERVICE.md)
  - [Email Delivery Workflow](cloudflare/EMAIL_DELIVERY_WORKFLOW.md)
- [Database Setup](database-setup/README.md)
  - [Multi-Tenancy Schema](database-setup/multi-tenancy-schema.md)
...
- [Deployment](deployment/README.md)
  ...
  - [Gradual Deployments](deployment/GRADUAL_DEPLOYMENTS.md)
...
- [Development](development/README.md)
  ...
  - [Monorepo Guide](development/monorepo.md)
  - [Monorepo Reference](development/MONOREPO.md)
- [Architecture](architecture/SYSTEM_ARCHITECTURE.md)
  ...
  - [Error Passing Architecture](architecture/error-passing.md)
  - [Worker Request Lifecycle](architecture/worker-request-lifecycle.md)
- [Frontend](frontend/README.md)
  ...
  - [Error UX](frontend/ERROR_UX.md)
  - [Error Architecture](frontend/ERROR_ARCHITECTURE.md)
...
- [Testing](testing/README.md)
  ...
  - [Newman CI Workflow](testing/newman-ci.md)
...
- [Authentication & Authorization](auth/README.md)
  - [Multi-Tenancy & Organizations](auth/multi-tenancy.md)
  ...
  - [Resend API Service](auth/resend-api-service.md)
  - [ZTA Review Fixes](auth/zta-review-fixes.md)
  - [Better Auth Audit 2026-05](auth/better-auth-audit-2026-05.md)
...
- [Security](security/ZERO_TRUST_ARCHITECTURE.md)
  ...
  - [Page Shield Integration](security/PAGE_SHIELD_INTEGRATION.md)
  - [Automated Web Asset Sync](security/API_SHIELD_WEB_ASSETS.md)
- [Middleware](middleware/hono-built-in-middleware.md)
  - [CORS Policy](middleware/cors.md)
  - [Turnstile Verification](middleware/turnstile.md)
...
- [Ops Tools](tools/README.md)
  ...
  - [Marimo, uv, and ty](tools/MARIMO_UV_TY.md)
