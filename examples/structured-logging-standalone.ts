/**
 * Standalone example demonstrating structured JSON logging
 * This example uses only the logger implementation without other dependencies
 *
 * Run with:
 * deno run examples/structured-logging-standalone.ts
 */

// Import just the logger types and classes
import { createLogger, LogLevel, StructuredLogger } from '../src/utils/logger.ts';
