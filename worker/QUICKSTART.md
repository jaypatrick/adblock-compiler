...
- Main bloqr-backend worker already deployed
...
This deploys the tail worker to Cloudflare as `bloqr-tail`.
...
- Make sure it's deployed: `wrangler deployments list --name bloqr-tail`
