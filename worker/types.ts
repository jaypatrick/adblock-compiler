...
/**
 * D1 Database types — re-exported from @cloudflare/workers-types.
 * These type aliases allow importing from worker/types.ts while using
 * the canonical global definitions (avoiding structural incompatibilities).
 */
