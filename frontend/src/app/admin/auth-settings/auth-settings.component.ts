            ...
            <mat-card appearance="outlined">
                ...
                <mat-card-content>
                    <mat-list>
                        <mat-list-item>
                            ...
                            <span matListItemLine>
                                <span class="badge" [class.badge-primary]="config()!.provider === 'better-auth'" [class.badge-warn]="config()!.provider === 'clerk'">
                                    {{ config()!.provider }}
                                </span>
                            </span>
                        </mat-list-item>
                        ...
                        <mat-list-item>
                            <mat-icon matListItemIcon aria-hidden="true">block</mat-icon>
                            <span matListItemTitle>Clerk (legacy)</span>
                            <span matListItemLine>
                                <span class="badge" [class.badge-warn]="config()!.clerk.enabled" [class.badge-ok]="!config()!.clerk.enabled">
                                    {{ config()!.clerk.enabled ? 'Active (legacy)' : 'Disabled ✓' }}
                                </span>
                            </span>
                        </mat-list-item>
                    </mat-list>
                    <p class="info-note">
                        ...
                        Clerk is currently disabled. To re-enable, set the
                        <code>CLERK_JWKS_URL</code> and <code>CLERK_PUBLISHABLE_KEY</code> environment variables.
                    </p>
                </mat-card-content>
            </mat-card>
